# 스마트 비바리움 제작 프로젝트
## 목적
- 본 프로젝트는 비바리움(구체적으로는 테라리움)과 IoT 구현을 위한 도구로서 ESP32 개발보드의 활용을 종합하여 스마트 비바리움을 제작하고, 이러한 과정에서 "메이킹 활동을 통한 즐거움"과 "IoT에 대한 지식과 이해(나아가 적용)"을 도모하기 위해 시작했습니다.<br>
- 여기서 멈추는 것이 아닌 지속적인 발전을 기대하며, 이를 위한 공부 및 공유를 함께하고 싶습니다.<br>
## 개발 환경
