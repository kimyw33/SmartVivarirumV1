...
**준비물**<br>
ESP32 보드 1개, USB 5핀 케이블(데이터 전송용) 1개, ESP32 쉴드(DOIT ESP32 DEVKIT V1) 1개, 온/습도 센서 1개, 조도 센서 1개, 푸쉬버튼 1개, OLED 1개, NeoPixel LED 2개, 각각의 모듈와 쉴드를 연결 할 3선/4선 케이블, 무선 네트워크 환경, 구글 계정 등(세부 준비물 내역은 아래 소단위 프로젝트마다 제시함.)<br>
**프로젝트의 흐름**<br>
...
**목적**  
이 프로젝트의 목적은 **ESP32와 DHT11 센서**를 사용하여 **주변 환경의 온도와 습도를 측정**하고, 그 값을 **시리얼 모니터**를 통해 실시간으로 확인하는 것입니다.<br>
이를 바탕으로 '실시간으로 측정된 온도와 습도값을 OLED 및 App 출력하는' 실습을 수행하게 됩니다.
