# 스마트 비바리움 제작 프로젝트
**목적**<br>
본 프로젝트는 초/중등 교원을 대상으로 한 연수 주제를 고민하던 중, 평소 취미생활로만 즐기던 비바리움과 최근 각광받고 있는 IoT 및 이를 구현하는 데 가성비가 좋은 ESP32 보드에 대한 공부를 시작하게 되며 기획하게 되었습니다.<br>
여기서 멈추는 것이 아닌, 다양한 버전으로의 발전을 기대하며, 이를 위한 꾸준한 공부 및 공유를 목표로 합니다.<br>
**준비물**<br>
ESP32 개발보드, USB 5핀 케이블(데이터 송수신용), ESP32 쉴드(DOIT ESP32 DEVKIT V1), 온/습도 센서, 조도 센서, 푸쉬버튼 스위치, OLED, NeoPixel LED, 각각의 모듈과 쉴드를 연결 할 3선/4선 케이블, 무선 네트워크 환경, 구글 계정 등(세부 준비물 내역은 아래 소단위 프로젝트마다 제시함.)<br>
**프로젝트의 흐름**<br>
...
추가로 10번 프로젝트에서는 앞선 08번 프로젝트에 5[V, DC] 팬을 추가함으로써 환기 기능을 추가하였고, 이를 위해 릴레이를 활용하였습니다.(릴레이의 기초 사용 방법은 09번 프로젝트 참고)
<details>
